...
class PoissionDenoisePass extends Pass {
  ...
  setSize(width, height) {
    ...
    _classPrivateFieldLooseBase(this, _updatePoissionDiskSamples)[_updatePoissionDiskSamples](
      width,
      height
    );
  }
  ...
  setMRTMaterialInScene() {
    ...
    for (const c of this.visibleMeshes) {
      ...
      mrtMaterial.uniforms.metalness.value =
        (_c$material$metalness = c.material.metalness) !== null && _c$material$metalness !== void 0
      ...
      Object.defineProperty(this, key, {
        ...
        set(value) {
          ...
          switch (key) {
            ...
            case 'depthPhi':
            case 'normalPhi':
              this.poissionDenoisePass.fullscreenMaterial.uniforms[key].value = Math.max(
                value,
                0.0001
              );
              break;
